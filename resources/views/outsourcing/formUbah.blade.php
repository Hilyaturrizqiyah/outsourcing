                    ...
                    <div class="card-body py-4 px-5">
                        ...
                        <div class="ms-3 name">
                            <div class="form-group">
                                ...
                                <h5>{{Session::get('nama_customer')}}</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <form enctype="multipart/form-data" class="contact-form-area contact-page-form contact-form text-left" action="{{url('admin/AksiTambahAdmin')}}" method="post">
                                        ...
                                        <input type="text" class="form-control" name="nama_admin" placeholder="{{Session::get('nama_customer')}}" >
                                        ...
                                        <textarea type="date" class="form-control" name="alamat" >{{$datas->alamat}}</textarea>
                                        ...
                                        <input type="text" class="form-control" name="email" placeholder="{{$datas->no_telp}}">
                                        ...
                                        <input type="text" class="form-control" name="password" placeholder="{{$datas->email}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_admin" placeholder="" >
