                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    @endif
                                    <form action="{{ url('/outsourcing/registerOsrPost') }}" method="post"
                                        class="user">
                                        @csrf
                                        <div class="form-group">
                                            <input type="nama_outsourcing" name="nama_outsourcing" class="form-control"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Nama Lengkap">
                                            @if ($errors->has('nama_outsourcing'))
                                            <span>
                                                <p class=" text-right">*
                                                    {{ $errors->first('nama_outsourcing') }}</p>
                                            </span>
                                            @endif
                                        </div>
                                        <div class="form-group">
