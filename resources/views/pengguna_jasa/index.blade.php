...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('pengguna/assets/vendors/iconly/bold.css') }}">
...
<body>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('assets/img/logo2.png') }}" width="200px"
                                    alt="Logo" srcset=""></a>
                        </div>
                        <div class="toggler">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-content">
                                <img class="img-fluid w-100" src="{{ asset('assets/img/logo-BSM.png') }}"
                                    alt="Card image cap">
                            </div>
                            <div class="card-footer">
                                <h4 class="card-title">Bintang Service Managemen</h4>
                                <p class="card-text">
                                    <i class="fas fa-maps">Jl.sindang</i>
                                </p>
                                <button class="btn btn-light-primary float-end">Read More</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="card">
                            <div class="card-content">
                                <img class="img-fluid w-100"
                                    src="{{ asset('assets/img/PT-kurnia-cahya-sejahtera.png') }}"
                                    alt="Card image cap">
                            </div>
                            <div class="card-footer">
                                <h4 class="card-title">PT Kurnia Cahya Sejahtera</h4>
                                <p class="card-text">
                                    <i class="fas fa-maps">Jl.sindang</i>
                                </p>
                                <button class="btn btn-light-primary float-end">Read More</button>
    ...
    <script src="{{ asset('pengguna/assets/vendors/apexcharts/apexcharts.js') }}"></script>
    <script src="{{ asset('pengguna/assets/js/pages/dashboard.js') }}"></script>
