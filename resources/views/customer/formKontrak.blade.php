                ...
                <div class="row">
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                {{-- <img src="{{ url('assets/img/jasa/'.$jenisjasa->foto) }}" class="rounded mx-auto d-block" width="600"> --}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="card mb-4">
                                    ...
                                    @endif
                                    <form enctype="multipart/form-data" class="contact-form-area contact-page-form contact-form text-left" action="{{url('ajukan')}}/{{ $jasa->id_jasa }}" method="post">

                                        {{csrf_field()}}

                                        <div class="form-group">
                                        <label><b>Jasa </b></label>
                                        <input type="text" class="form-control" name="nama_admin" placeholder="{{$jasa->nama_jasa}}" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nama_admin" placeholder="{{$jasa->outsourcing->nama_outsourcing}}" disabled>
                                        ...
                                        <input type="date" class="form-control" name="tgl_mulai_kontrak" placeholder="Masukkan Alamat Admin"></input>

                                        @if ($errors->has('alamat'))
                                            <span class="text-danger"><p class="text-right">* {{ $errors->first('tgl_mulai_kontrak') }}</p></span>
                                        @endif
                                        ...
                                        <div class="row">
                                            <div class="col">
                                              <input type="text" class="form-control" name="lamaKontrak" placeholder="Lama kontrak" aria-label="First name">
                                            </div>
                                            <div class="col">
                                              <select name="deskripsi" id="select" type="select" class="form-select">
                                                <option value="Hari" name="deskripsi">Hari</option>
                                                <option value="Bulan" name="deskripsi" type="select">Bulan</option>
                                                <option value="Tahun" name="deskripsi" type="select">Tahun</option>
                                              </select>
                                            </div>
                                          </div>
                                        ...
                                        <input type="number" class="form-control" name="jumlah_tenagaKerja" placeholder="Masukkan Jumlah">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" class="btn btn-primary" value="Ajukan Kontrak">
                                        </div>
                                    </form>
                                </div>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user"></i>  Penyewa Jasa</h6>
                                </div>
                                ...
                                <div class="form-group">
                                    <tr>
                                        ...
                                        <td width="15px">:</td>
                                        <td>{{Session::get('nama_customer')}}</td>
                                    </tr>
                                </div>
