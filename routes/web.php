...
Route::get('/outsourcing/register', 'OutsourcingController@registerOsr');
Route::post('/outsourcing/registerOsrPost', 'OutsourcingController@registerOsrPost');
...
// Route::get('/admin/UbahJenisJasa{id_jenisJasa}','MengelolaJenisJasaController@edit');
// Route::post('/admin/AksiUbahJenisJasa{id_jenisJasa}','MengelolaJenisJasaController@update');
Route::get('/outsourcing/HapusTenagaKerja{id_tenagaKerja}','MengelolaTenagaKerjaController@delete');
...
Route::get('/outsourcing/HapusDataKomplain{id_komplain}', 'OutsourcingController@delete');


Route::get('/outsourcing/TransaksiPerlengkapan', 'TransaksiPerlengkapanController@index');
Route::get('/outsourcing/HapusTransPerlengkapan{id_pembayaranPerlengkapan}', 'TransaksiPerlengkapanController@delete');


Route::get('/outsourcing/TransaksiTenagaKerja', 'TransaksiTenagaKerjaController@index');
Route::get('/outsourcing/HapusTransTenagaKerja{id_pembayaranTenagaKerja}', 'TransaksiTenagaKerjaController@delete');
...
Route::post('/outsourcing/validasiBayarPerlengkapan/{id_kontrak}', 'OutsourcingController@validasiBayarPerlengkapan');
