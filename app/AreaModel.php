...
class AreaModel extends Model
{
    ...
    public function KotaKabupaten() {
        return $this->belongsTo(kota_kabupatenModel::class,'id_kotaKabupaten');//model_tabel_yang_mau_disambungin, nama_tabel_perantara, foreignkey1_pada_tabel_penghubung, foreignkey2_pada_tabel_penghubung)
    }
